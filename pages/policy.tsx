  ...
  return (
    <div className="px-24 py-5">
      <p className="text-2xl">
        ...
        our commitment to providing you with the finest coffee beans from around
        the world.
      </p>
      <br />
      ...
      <p className="text-2xl">
        ...
        farmers in different corners of the globe, ensuring that they receive
        fair compensation for their hard work and dedication. By choosing
      ...
      <p className="text-2xl">
        ...
        brewing tips, or simply want to chat about your coffee preferences, our
        team is here for you. We believe in fostering a friendly and inclusive
        coffee community.
      </p>
      <br />
      ...
      <p className="text-2xl">
        ...
        receive is bursting with flavor. We are committed to delivering coffee
        beans at their peak freshness so you can savor the rich and aromatic
        notes in every sip.
      </p>
      <br />
      <p className="text-2xl">
